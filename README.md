...
<p align="left">
  ...
  <a href="https://goreportcard.com/report/github.com/MultiverseChronicles/go-libp2p-pubsub"><img src="https://goreportcard.com/badge/github.com/MultiverseChronicles/go-libp2p-pubsub" /></a>
  <a href="https://github.com/RichardLitt/standard-readme"><img src="https://img.shields.io/badge/readme%20style-standard-brightgreen.svg?style=flat-square" /></a>
  <a href="https://godoc.org/github.com/MultiverseChronicles/go-libp2p-pubsub"><img src="http://img.shields.io/badge/godoc-reference-5272B4.svg?style=flat-square" /></a>
...
- Gossipsub, which is a more advanced router with mesh formation and gossip propagation. See [spec](https://github.com/MultiverseChronicles/specs/tree/master/pubsub/gossipsub) and  [implementation](https://github.com/MultiverseChronicles/go-libp2p-pubsub/blob/master/gossipsub.go) for more details.
...
```
go get github.com/MultiverseChronicles/go-libp2p-pubsub
```
...
https://github.com/MultiverseChronicles/go-libp2p/tree/master/examples/pubsub

## Documentation

See the [libp2p specs](https://github.com/MultiverseChronicles/specs/tree/master/pubsub) for high level documentation and [godoc](https://godoc.org/github.com/MultiverseChronicles/go-libp2p-pubsub) for API documentation.
...
If you want to trace using a remote peer, you can do so using the `traced` daemon from [go-libp2p-pubsub-tracer](https://github.com/MultiverseChronicles/go-libp2p-pubsub-tracer). The package also includes a utility program, `tracestat`, for analyzing the traces collected by the daemon.
...
Contributions welcome. Please check out [the issues](https://github.com/MultiverseChronicles/go-libp2p-pubsub/issues).

Check out our [contributing document](https://github.com/MultiverseChronicles/community/blob/master/contributing.md) for more information on how we work, and about contributing in general. Please be aware that all interactions related to multiformats are subject to the IPFS [Code of Conduct](https://github.com/ipfs/community/blob/master/code-of-conduct.md).
